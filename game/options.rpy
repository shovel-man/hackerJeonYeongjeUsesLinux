...
define config.name = _("hackerJeonYeongjeUsesLinux")
...
define build.name = "hackerJeonYeongjeUsesLinux"
...
define config.save_directory = "hackerJeonYeongjeUsesLinux-1750400448"
